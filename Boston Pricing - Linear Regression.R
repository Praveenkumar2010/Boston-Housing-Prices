...
#function that gives you the correlation values between all IDV's and the DV
#shortlist Which all IDV's are correlated to the DV
...
#drop variables if they have a vif>10 ; means high correlation between variables
